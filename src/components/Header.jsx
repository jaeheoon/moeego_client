...
function Header() {
    ...
    const { isLoggedIn, loginEmail, loginUser, loginStatus, loginProfile } =
        ...
        try {
            ...
            if (error.response) {
                if (error.response.status === 404) {
                    console.error(
                        "Error: 사용자 정보를 찾을 수 없거나 이메일 상태를 찾을 수 없습니다."
                    );
                    alert(
                        "사용자를 찾을 수 없거나 이메일 상태를 찾을 수 없습니다."
                    );
                } else {
                    console.error(
            ...
            <div className="header-container">
                ...
                {isMenuOpen && (
                    <div className="dropdown-menu" ref={dropdownRef}>
                        ...
                        <ul>
                            {isLoggedIn ? (
                                <li className="HamburgerUserInfoWrap">
                                    <Link
                                        to="/mypage"
                                        className="HamburgerUserInfoLinkWrap"
                                        onClick={closeMenu}
                                    >
                                        <div>
                                            <div>
                                    ...
                                    <div className="HamburgerUserInfoButtonWrap">
                                        ...
                                        {loginStatus !== "ROLE_PRO" &&
                                            ...
                                            loginStatus !== "ROLE_ADMIN" &&
                                            loginStatus !== "ROLE_CANCEL_PRO" &&
                                            loginStatus !== "ROLE_CANCEL" && (
                                                <input
                                                    type="button"
                                                    value="달인전환"
                                                    onClick={() => {
                            ...
                            <li>
                                <Link to="/pro/search" onClick={closeMenu}>
                                    달인찾기
                                </Link>
                            </li>
                            <li>
                        ...
                        {/* 다크모드 버튼 */}
                        <div className="toggle-switch-hamburger">
                            <input
                                type="checkbox"
                                id="darkModeToggle"
                                checked={isDarkMode}
                ...
                <div className="logo">
                    <Link to="/">
                        <img src="/image/moeego.png" alt="moeegoLogo" />
                    </Link>
                </div>
                ...
                <div className="user-menu">
                    ...
                    {modalType === "userMenu" && (
                        <div className="ToggleMenu" onClick={closeModal}>
                            <div
                                className="ToggleMenuList"
                                onClick={(e) => e.stopPropagation()}
                            >
                                <HeaderModal
                                    closeModal={closeModal}
                                    closeAndAccessMenu={closeAndAccessMenu}
                                    GoProAccess={GoProAccess}
            ...
            <div className="moblie-search-insert">
                {isSearchVisible && (
                    <div className="moblie-search-bar">
                        ...
                        />
                        <button
                            className="moblie-search-button"
                            onClick={() => handleSearch(searchValue)}
                        >
                            <svg
                                viewBox="0 0 24 24"
