...
import '../../../css/articles/PopularPostItem.css'
const PopularPostItem = ({ item }) => {
    return (
        <div className='popularItemWrap'>
            <div className='popularItemWrap-content'>
                <div className='popularItemWrap-title_content'>
                    <div className='popularItemTitleWrap'>
                        <div>{item.subject}</div>
                    </div>
                    <div className="popularItemContentWrap">
                        <div style={{ whiteSpace: 'pre-wrap' }}>
                            {item.content}
                        </div>
                    </div>
                </div>
                <div className='popularItemWrap-img'>
            ...
            <div className='popularItemWrap-location'>
                {item.area == '지역' ? "" : item.area}
            </div>

            <div className='popularItemWrap-bot'>
                <div className='popularImageWrap'>
                    <div>
                ...
                <div className='popularItem-written-time-warp'>
