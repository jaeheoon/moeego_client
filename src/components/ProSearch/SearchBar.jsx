...
const SearchBar = () => {
  ...
  useEffect(() => {
    const fetchedItems = [
      { name: '서울 송파구/코딩달인/정세묵/수업 안들어도 코딩고수 가능!', lat: 37.510608, lng: 127.100834 },
      { name: '서울 강남구/웹 개발/김소영/비전공자도 고수 될 수 있어!', lat: 37.498095, lng: 127.027610 },
      { name: '서울 마포구/UX디자인/김태훈/디자인 실력 향상!', lat: 37.563213, lng: 126.906197 },
      { name: '서울 서초구/데이터 분석/이민지/통계로 세상을 변화시킨다!', lat: 37.484307, lng: 127.032142 },
