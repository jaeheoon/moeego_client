    ...
    return (
        <div class="info">
            <div class="info-section-header">
                <h1 class="nickname">mc딩동</h1>
                <div class="icon-buttons">
                    <div role="button" class="heart">
            ...
            <div class="info-sub-header">
                ...
                <div class="address"> 서울 구로구/ 50km 이동가능 </div>
            </div>
            <div class="introduce">달인의 스피치 컨설팅</div>
            <div class="detail-info">
                <div class="statistics-info"> 
                    <div class="statistics-info-item">
                        <div class="statistics-info-item-header">고용</div>
                        <div class="statistics-info-item-contents">1회</div>
                    </div>
                    <div class="statistics-info-item">
                        <div class="statistics-info-item-header">리뷰</div>
                    ...
                    <div class="statistics-info-item">
                        ...
                        <div class="statistics-info-item-contents">10년</div>
                    </div>
                </div>
            </div>
        </div>
